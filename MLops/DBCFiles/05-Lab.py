...
X_train_processed = X_train_processed.drop(['latitude', 'longitude', 
...
X_test_processed = X_test_processed.drop(['latitude', 'longitude', 
                                            'review_scores_accuracy', 'review_scores_cleanliness', 'review_scores_checkin', 'review_scores_communication',
                                            'review_scores_location', 'review_scores_value']
                                         , axis=1)
...
#         model_input = model_input.copy()
        ...
        model_input = model_input.drop(['latitude', 'longitude', 
                                        'review_scores_accuracy', 'review_scores_cleanliness', 'review_scores_checkin', 'review_scores_communication',
                                        'review_scores_location', 'review_scores_value']
                                       , axis=1)       
        return model_input
...
class RF_with_postprocess(mlflow.pyfunc.PythonModel):
    ...
    def postprocess_result(self, results):
        ...
        results = np.where(results > 100, 'Expensive', 'Non Expensive')
        return results
